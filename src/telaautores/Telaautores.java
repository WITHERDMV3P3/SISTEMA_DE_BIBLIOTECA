...
public class Telaautores extends JFrame {
	...
	public static void main(String[] args) {
		Telaautores chamar = new Telaautores();
		chamar.chamar();
	}
	...
	public void chamar() {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					 UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
					Telaautores frame = new Telaautores();
	...
	public Telaautores() {
		...
		panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "OP\u00C7\u00D5ES AUTORES", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
