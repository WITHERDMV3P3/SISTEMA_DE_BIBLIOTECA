...
public class Telalivro extends JFrame {
	...
	public static void main(String[] args) {
		Telalivro chamar = new Telalivro();
		chamar.chamar();
	}
	...
	public Telalivro() {
		...
		panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "OP\u00C7\u00D5ES LIVRO", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
